...
[![Rating](https://img.shields.io/visual-studio-marketplace/r/abdullahmia.personal-todo-list?style=flat-square)](https://marketplace.visualstudio.com/items?itemName=abdullahmia.personal-todo-list)
...
See [COMMIT_GUIDELINES.md](COMMIT_GUIDELINES.md) for detailed information.
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/vanto/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/vanto/discussions)
...
[Install Now](https://marketplace.visualstudio.com/items?itemName=abdullahmia.personal-todo-list) • [Documentation](#) • [Changelog](changelog.md)
